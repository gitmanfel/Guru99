<html>
<!-- comments:Application home page-->
...
<head>
    ...
    <title> Guru99 Bank Customer HomePage </title>
</head>
<div>
    <div>
        <ul class="menusubnav">
...
<!--comments: home page body-->

<body>
    <table class="layout1" border="0" align="center">
        <td>
            <table align="center" width="70%">
                <center><img src="../images/1.gif"><img src="../images/3.gif"><img src="../images/2.gif"></center>
                </tr>
                <!--comments: To link all the screens-->
                <tr>
                    <td>
                        <marquee class="heading3" behavior="alternate">Welcome To Customer's Page of Guru99 Bank
                        </marquee>
                    </td>
                </tr>
            </table>
